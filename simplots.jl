...
data0 = [loadit(generate.getfilenamelocal("data", "5_16_26_h", true, ρ)) for ρ in 0:dρ:maxρ]
data1 = [loadit(generate.getfilenamelocal("data", "5_16_26_h", false, ρ)) for ρ in 0:dρ:maxρ]
