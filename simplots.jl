...
data0 = [loadit(generate.getfilenamelocal("data", "5_17_26_g", true, ρ)) for ρ in 0:dρ:maxρ]
data1 = [loadit(generate.getfilenamelocal("data", "5_17_26_g", false, ρ)) for ρ in 0:dρ:maxρ]
