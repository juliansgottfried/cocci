...
data0 = [loadit(generate.getfilenamelocal("data", "5_17_26_c", true, ρ)) for ρ in 0:dρ:maxρ]
data1 = [loadit(generate.getfilenamelocal("data", "5_17_26_c", false, ρ)) for ρ in 0:dρ:maxρ]
